...
<div class="container" style="padding-top: 30px;">
  <div class="register-form">
    ...
    <%
      ...
      if (userEmail == null) {
        request.setAttribute("error", "Please log in to view order history.");
        request.getRequestDispatcher("login.jsp").forward(request, response);
        return;
      }
      DBConnector db = new DBConnector();
      Connection conn = db.getConnection();
      String query = "SELECT * FROM Orders WHERE UserEmail = ? AND (OrderId LIKE ? OR ? IS NULL) AND (OrderDate LIKE ? OR ? IS NULL)";
      ...
      stmt.setString(3, request.getParameter("orderId"));
      stmt.setString(4, searchDate);
      stmt.setString(5, request.getParameter("orderDate"));
